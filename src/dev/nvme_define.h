...
//
#define GUID_WCS_DEVICE_SMART_ATTRIBUTESGuid                                           \
    {                                                                                  \
        0x2810AFC5, 0xBFEA, 0xA4F2, { 0x9C, 0x4F, 0x6F, 0x7C, 0xC9, 0x14, 0xD5, 0xAF } \
    }
...
//
#define GUID_WCS_DEVICE_ERROR_RECOVERYGuid                                             \
    {                                                                                  \
        0x2131D944, 0x30FE, 0xAE34, { 0xAB, 0x4D, 0xFD, 0x3D, 0xBA, 0x83, 0x19, 0x5A } \
    }
...
} NVME_WCS_DEVICE_RECOVERY_ACTION,
    *PNVME_WCS_DEVICE_RECOVERY_ACTION;
...
typedef enum
{
    ...
    *PNVME_SANITIZE_OPERATION_STATUS;
...
typedef enum
{
    ...
    *PNVME_NO_DEALLOCATE_MODIFIES_MEDIA_AFTER_SANITIZE;
